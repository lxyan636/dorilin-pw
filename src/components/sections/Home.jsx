...
export const Home = ({ setActiveSection }) => {
    return (
        <section id="home" className="min-h-screen flex items-center justify-center relative bg-[#D4D3B3]">
            <RevealOnScroll>
                <div className="text-center z-10 px-4">
                    ...
                    <div className="flex flex-col justify-center items-center space-y-4">
                        <button
                            ...
                            className="bg-[#8D926F] font-bold text-[#fbf6e0] px-6 py-3 w-50
                        ...
                        <button
                            ...
                            className="font-bold bg-[#8a5128]/70 border border-[#8a5128] text-[#fbf6e0] px-6 py-3 w-50
